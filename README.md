...
| Section | Output |
|---|---|
| Baseline scenario | Net loss €-1.7M (Table 3 exact staff limits) |
| Optimal (no CO2 cap) | Net profit €18.3M |
| **Optimal + CO2 cap** | **Net profit €17.4M** ← primary scenario |
| Bordeaux shutdown | Profit drops 0.2% (Lyon absorbs capacity) |
| Capella disruption | Profit drops 109% (extracts are critical) |
| NY+Shanghai surge | €624k additional shortage penalties |
| Monte Carlo VaR (5%) | €7.2M guaranteed floor (95% confidence) |
| VSS (Stochastic SP) | ~€19M benefit of stochastic over deterministic planning |
...
| 4 | [Customer Churn Prediction](../Customer-Churn-Prediction) | Python · XGBoost · SHAP · LIME |
| **5** | **Global Supply Chain Optimisation ← You are here** | **Python · MILP · Monte Carlo · Stochastic SP** |
